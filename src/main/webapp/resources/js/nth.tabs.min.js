(function(a) {
	a.fn.nthTabs = function(c) {
		...
		var e = a.extend({}, g, c);
		var d = '<div class="page-tabs"><a href="javascript:;" class="roll-nav roll-nav-left"><span class="fa fa-backward"></span></a><div class="content-tabs"><div class="content-tabs-container"><ul class="nav nav-tabs"></ul></div></div><a href="javascript:;" class="roll-nav roll-nav-right"><span class="fa fa-forward"></span></a><div class="dropdown roll-nav right-nav-list"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="fa fa-chevron-down"></span></a><ul class="dropdown-menu"><li><a href="javascript:;" class="tab-location">\u5b9a\u4f4d\u5f53\u524d\u9009\u9879\u5361</a></li><li><a href="javascript:;" class="tab-close-current">\u5173\u95ed\u5f53\u524d\u9009\u9879\u5361</a></li><li role="separator" class="divider"></li><li><a href="javascript:;" class="tab-close-other">\u5173\u95ed\u5176\u4ed6\u9009\u9879\u5361</a></li><li><a href="javascript:;" class="tab-close-all">\u5173\u95ed\u5168\u90e8\u9009\u9879\u5361</a></li><li role="separator" class="divider"></li><li class="scrollbar-outer tab-list-scrollbar"><div class="tab-list-container"><ul class="tab-list"></ul></div></li></ul></div></div><div class="tab-content" style="padding:20px"></div>';
		var b = {
			init : function() {
				h.html(d);b.listen()
			},
			...
			getActiveId : function() {
				return h.find('li[class="active"]').find("a").attr("href").replace("javascript:;", "")
			},
			getTabList : function() {
				var i = [];
			...
			addTab : function(j) {
				...
				m = m ? "active" : "";k.push('<li role="presentation" class="' + m + '">');k.push('<a href="#' + j.id + '" data-toggle="tab">');k.push("<span>" + j.title + "</span>");
				i ? k.push('<i class="fa fa-close tab-close"></i>') : "";k.push("</a>");k.push("</li>");h.find(".nav-tabs").append(k.join(""));
				var l = [];
				l.push('<div class="tab-pane ' + m + '" id="' + j.id + '">');l.push(j.content);l.push("</div>");h.find(".tab-content").append(l.join(""));return b
			},
			locationTab : function(j) {
				...
				i.css("margin-left", margin_left_total);return b
			},
			delTab : function(j) {
				j = j == undefined ? b.getActiveId() : j;
				j = j.indexOf("#") > -1 ? j : "#" + j;
				...
				if (k.parent().attr("class") == "active") {
					...
					i.addClass("active");l.addClass("active")
				}
				k.parent().remove();a(j).remove();return b
			},
			delOtherTab : function() {
				h.find(".nav-tabs li").not('[class="active"]').remove();h.find(".tab-content div").not('[class="tab-pane active"]').remove();return b
			},
			delAllTab : function() {
				h.find(".nav-tabs li").remove();h.find(".tab-content div").remove();return b
			},
			setActTab : function(i) {
				i = i == undefined ? b.getActiveId() : i;
				i = i.indexOf("#") > -1 ? i : "#" + i;h.find(".active").removeClass("active");h.find("[href='" + i + "']").parent().addClass("active");h.find(i).addClass("active");return b
			},
		};
		var f = {
			...
			onTabList : function() {
				...
				});h.find(".tab-list-scrollbar").scrollbar();f.onTabListToggle();return f
			},
